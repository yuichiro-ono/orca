...
Seiko._raw(encode("0x1B 0x40"))
Seiko._raw(encode("0x1B 0x52 8"))		# International characer select
Seiko._raw(encode("0x1C 0x43 1"))	    # FS C （Shift JISコード体系を選択する）電源offまで有効
Seiko.text("ABCD")
Seiko.cut()
