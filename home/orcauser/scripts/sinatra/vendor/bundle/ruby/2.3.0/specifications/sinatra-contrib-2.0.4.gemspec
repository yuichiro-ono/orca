...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<sinatra>, ["= 2.0.4"])
      ...
      s.add_runtime_dependency(%q<rack-protection>, ["= 2.0.4"])
      ...
      s.add_dependency(%q<sinatra>, ["= 2.0.4"])
      ...
      s.add_dependency(%q<rack-protection>, ["= 2.0.4"])
